...
{ 
  ...
  if(season == "testing") 
  {
    if(file.exists(paste(direct,"Data/Survey_data/",as.numeric(format(Sys.time(), "%Y")),"/Survey_summary_output/testing_results.Rdata",sep=""))==T) 
    {                   
      load(paste(direct,"Data/Survey_data/",as.numeric(format(Sys.time(), "%Y")),
...
# Now we'll need to do a few things differently if there are no survey strata on a bank, this will work for Middle and German
    ...
    if(fig == "pdf") pdf(paste(plot.dir,"survey_strata.pdf",sep=""),width = 11,height = 8.5,bg = "transparent")
...
################  Next up are the rest of the spatial plots ###########################
    ...
    if(fig == "png") png(paste(plot.dir,spatial.maps[k],".png",sep=""),units="in",width = 11, height = 8.5,res=420,bg = "transparent")
    if(fig == "pdf") pdf(paste(plot.dir,spatial.maps[k],".pdf",sep=""),width = 11, height = 8.5,bg = "transparent")
    if(fig == "screen") windows(11,8.5)
    par(mfrow=c(1,1))
...
####################################  MWSH and CF Time series plot #################################### 
      ...
      if(fig== "png") png(paste(plot.dir,"MWSH_and_CF_ts.png",sep=""),units="in",width = 13,height = 8.5,res=420,bg = "transparent")
      if(fig== "pdf") pdf(paste(plot.dir,"MWSH_and_CF_ts.pdf",sep=""),width = 13,height = 8.5,bg = "transparent")
    ...
    if(any(plots=="abund-ts"))
      {
        ...
        if(fig == "png") png(paste(plot.dir,"abundance_ts.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg="transparent")
        if(fig == "pdf") pdf(paste(plot.dir,"abundance_ts.pdf",sep=""),width = 8.5, height = 11,bg="transparent")
        if(fig == "screen") windows(11,8.5)
...
#####   THE BIOMASS TIME SERIES FIGURE #####   THE BIOMASS TIME SERIES FIGURE#####   THE BIOMASS TIME SERIES FIGURE      
      ...
      if(fig == "screen") windows(11,8.5)
      if(fig == "png") png(paste(plot.dir,"biomass_ts.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg="transparent")
      if(fig == "pdf") pdf(paste(plot.dir,"biomass_ts.pdf",sep=""),width = 8.5, height = 11,bg="transparent")
...
##### Shell height frequency figure            ##### Shell height frequency figure ##### Shell height frequency figure
  ...
  if(any(plots=="SHF"))
    ...
    if(fig == "png") png(paste(plot.dir,"SHF.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg="transparent")
    if(fig == "pdf") pdf(paste(plot.dir,"SHF.pdf",sep=""),width = 8.5, height = 11,bg="transparent")
    ...
    if(banks[i]=="Ger")
      {
        ...
        if(fig == "screen") windows(8.5,11)
        if(fig == "png") png(paste(plot.dir,"shell_height_freqency-repeated.png",sep=""),units="in",width = 11, height = 8.5,res=420,bg="transparent")
        if(fig == "pdf") pdf(paste(plot.dir,"shell_height_freqency-repeated.pdf",sep=""),width = 11, height = 8.5,bg="transparent")
...
##### END Shell height frequency figure   ##### END Shell height frequency figure ##### END Shell height frequency figure
  ...
  if(any(plots=="SHF-large"))
  {
    ...
    if(fig == "pdf") pdf(paste(plot.dir,"SHF-large.pdf",sep=""),width = 8.5, height = 11,bg="transparent")
    # Grab the last 7 years of data
  ...
  if(any(plots=="SHF-split"))
  {
    ...
    if(fig == "pdf") pdf(paste(plot.dir,"SHF-split.pdf",sep=""),width = 8.5, height = 11,bg="transparent")
    # Grab the last 7 years of data
  ...
  if(any(plots== "clapper-abund-ts"))
    {
      ...
      if(fig == "screen") windows(8.5,11)
      if(fig == "png") png(paste(plot.dir,"Clapper_abund_ts.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg = "transparent")
      if(fig == "pdf") pdf(paste(plot.dir,"Clapper_abund_ts.pdf",sep=""),width = 8.5, height = 11,bg = "transparent")
      if(banks[i] != "Ger" && banks[i] != "Mid" && banks[i] != "GB")
        {
  ...
  if(any(plots== "clapper-per-ts"))
    {
      ...
      if(fig == "screen") windows(8.5,11)
      if(fig == "png") png(paste(plot.dir,"Clapper_per_ts.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg = "transparent")
      if(fig == "pdf") pdf(paste(plot.dir,"Clapper_per_ts.pdf",sep=""),width = 8.5, height = 11,bg = "transparent")
      yrs <- min(surv.Clap.Rand[[banks[i]]]$year,na.rm=T):max(surv.Clap.Rand[[banks[i]]]$year,na.rm=T)
      ...
      if(any(plots== "SH-MW-CF-ts"))
        {
          ...
          if(fig == "pdf") pdf(paste(plot.dir,"SH_MW_CF_ts.pdf",sep=""),width = 8.5,height = 11,bg = "transparent")
...
############  Breakdown figures for BBn and GB############  Breakdown figures for BBn and GB############  Breakdown figures for BBn and GB  
  ...
  if(any(plots== "breakdown"))
  {
    ...
    #{
      if(fig == "screen") windows(11,8.5)
      if(fig == "png") png(paste(plot.dir,"breakdown.png",sep=""),units="in",width = 11,height = 8.5,res=420,bg = "transparent")
      if(fig == "pdf") pdf(paste(plot.dir,"breakdown.pdf",sep=""),width = 11,height = 8.5,bg = "transparent")
  ...
  if(any(plots %in% "seedboxes"))    
  {
    ...
    if(nrow(sb) > 0) # only run the rest of this if we have data...
    {
      ...
      for(j in 1:n.box)
      {
        ...
        if(fig == "png") png(paste(plot.dir,box.names[j],"-abundance_ts.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg = "transparent")
        if(fig == "pdf") pdf(paste(plot.dir,box.names[j],"-abundance_ts.pdf",sep=""),width = 8.5, height = 11,bg = "transparent") 
        if(fig == "screen") windows(8.5,11)
        ...
        if(fig == "png") png(paste(plot.dir,box.names[j],"-biomass_ts.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg = "transparent")
        if(fig == "pdf") pdf(paste(plot.dir,box.names[j],"-biomass_ts.pdf",sep=""),width = 8.5, height = 11,bg = "transparent") 
        if(fig == "screen") windows(8.5,11)
        ...
        if(fig == "screen") windows(11,8.5)
        if(fig == "png") png(paste(plot.dir,box.names[j],"-breakdown.png",sep=""),units="in",width = 11,height = 8.5,res=420,bg = "transparent")
        if(fig == "pdf") pdf(paste(plot.dir,box.names[j],"-breakdown.pdf",sep=""),width = 11,height = 8.5,bg = "transparent")
        ...
        if(fig == "png") png(paste(plot.dir,box.names[j],"-SHF.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg = "transparent") 
        if(fig == "pdf") pdf(paste(plot.dir,box.names[j],"-SHF.pdf",sep=""),width = 8.5, height = 11,bg = "transparent") 
        if(fig == "screen") windows(8.5,11)
        ...
        if(fig == "png") png(paste(plot.dir,box.names[j],"-SHF-large.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg = "transparent")
        if(fig == "pdf") pdf(paste(plot.dir,box.names[j],"-SHF-large.pdf",sep=""),width = 8.5, height = 11,bg = "transparent") 
        if(fig == "screen") windows(8.5,11)
        shf.plt(boxy,from='surv',yr=shf.years, col1='grey80',col2=1,rel=F,select=60,
                recline=c(RS,CS),add.title = add.title,titl = seedbox.SHF.title,cex.mn=3,sample.size = s.size)
        if(fig != "screen") dev.off()
        # Now do the SHF with the panels split classes...
        if(fig == "png") png(paste(plot.dir,box.names[j],"-SHF-split.png",sep=""),units="in",width = 8.5, height = 11,res=420,bg = "transparent") 
        if(fig == "pdf") pdf(paste(plot.dir,box.names[j],"-SHF-split.pdf",sep=""),width = 8.5, height = 11,bg = "transparent") 
        if(fig == "screen") windows(8.5,11)
        ...
        if(fig == "png") png(paste(plot.dir,box.names[j],"-spatial.png",sep=""),units="in",width = 11, height = 8.5,res=420,bg = "transparent")
        if(fig == "pdf") pdf(paste(plot.dir,box.names[j],"-spatial.pdf",sep=""),width = 11, height = 8.5,bg = "transparent")
        if(fig == "screen") windows(11,8.5)
